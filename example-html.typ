// brutalist-webzine — HTML/static site version
// compile: typst compile --features html --format html example-html.typ example.html

#import "lib.typ": *

#show: webzine-html.with(
  title:  "SIGNAL/NOISE",
  issue:  "07",
  date:   "SUMMER 2025",
  accent: rgb("#ff2d00"),
...
#callout(title: "HOW TO COMPILE THIS ZINE", accent: rgb("#0066ff"))[
  ...
  *HTML (static site):*
  ...
  typst compile --features html \
    --format html example-html.typ example.html
  ```
